...
<section class="content">
    <div class="row">
           <div class="col-sm-12">
            <a href="{$_layoutParams.root}almacen/marcas/exel" class="btn btn-info"> 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                     <form class="form-horizontal" id="form-ins" method="{$_layoutParams.root}almacen/marcas/insertar_ajax">
                        <input type="hidden" name="marcas_id" value="0" id="hiddent-des_m-ins">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="" class="col-sm-4 control-label">Descripcion</label>
                                <div class="col-sm-8">
                                    <input type="text" name="txtdescripcion" class="form-control" id="inp-des_m-ins"
